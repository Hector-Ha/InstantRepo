export namespace domain {
	...
	export class AIEnvReviewSettings {
	    enabled: boolean;
	    // Go type: time
	    updatedAt?: any;
	
	    static createFrom(source: any = {}) {
	        return new AIEnvReviewSettings(source);
	    }
	...
	export class EnvContributionQueueStatus {
	    count: number;
	    // Go type: time
	    oldestCreatedAt?: any;
	
	    static createFrom(source: any = {}) {
	        return new EnvContributionQueueStatus(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.count = source["count"];
	        this.oldestCreatedAt = this.convertValues(source["oldestCreatedAt"], null);
	    }
	...
	export class EnvContributionSettings {
	    ...
	    static createFrom(source: any = {}) {
	        return new EnvContributionSettings(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.publicEnvPatternsEnabled = source["publicEnvPatternsEnabled"];
	        this.privateLocalEnvPatternsEnabled = source["privateLocalEnvPatternsEnabled"];
	        this.consentShown = source["consentShown"];
	        this.updatedAt = this.convertValues(source["updatedAt"], null);
	    }
	...
	export class EnvContributionSettingsResponse {
	    settings: EnvContributionSettings;
	    queue: EnvContributionQueueStatus;
	
	    static createFrom(source: any = {}) {
	        return new EnvContributionSettingsResponse(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.settings = this.convertValues(source["settings"], EnvContributionSettings);
	        this.queue = this.convertValues(source["queue"], EnvContributionQueueStatus);
	    }
	...
	export class EnvVaultApproval {
	    ...
	    static createFrom(source: any = {}) {
	        return new EnvVaultApproval(source);
	    }
	...
	export class EnvVaultEntry {
	    ...
	    static createFrom(source: any = {}) {
	        return new EnvVaultEntry(source);
	    }
	...
	export class EnvVaultPromptCandidate {
	    ...
	    static createFrom(source: any = {}) {
	        return new EnvVaultPromptCandidate(source);
	    }
	...
	export class EnvVaultPromptSuppression {
	    repoPath: string;
	    targetRelativePath: string;
	    variableName: string;
	    // Go type: time
	    ...
	    static createFrom(source: any = {}) {
	        return new EnvVaultPromptSuppression(source);
	    }
	...
	export class EnvVaultSaveRequest {
	    provider: string;
	    variableName: string;
	    displayName?: string;
	    value: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new EnvVaultSaveRequest(source);
	    }
	...
	export class EnvVaultSaveResponse {
	    entry?: EnvVaultEntry;
	    needsReview: boolean;
	    reviewMessage?: string;
	
	    static createFrom(source: any = {}) {
	        return new EnvVaultSaveResponse(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.entry = this.convertValues(source["entry"], EnvVaultEntry);
	        this.needsReview = source["needsReview"];
	        this.reviewMessage = source["reviewMessage"];
	    }
	...
	export class InstalledRepoSummary {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.projectName = source["projectName"];
	        this.localPath = source["localPath"];
	        this.localPathExists = source["localPathExists"];
	        this.status = source["status"];
	        this.lastAnalyzedAt = this.convertValues(source["lastAnalyzedAt"], null);
