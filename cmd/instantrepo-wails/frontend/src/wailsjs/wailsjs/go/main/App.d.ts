...
export function AIEnvReviewSettings():Promise<domain.AIEnvReviewSettings>;
...
export function SaveAIEnvReviewSettings(arg1:domain.AIEnvReviewSettings):Promise<domain.AIEnvReviewSettings>;
